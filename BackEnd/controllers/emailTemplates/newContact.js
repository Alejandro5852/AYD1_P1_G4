                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                ...
                                El motivo del presente correo es para notificarte que has sido añadido a la lista de contactos del grupo 4 de AyD1 
                            </td>
                        </tr>
                    </tbody></table>
                    <!--[if mso]>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 10px;">
                                    <a class="mcnButton " title="TE RECOMIENDO UNA CANCIÓN &lt;3" href="https://open.spotify.com/track/5p7GiBZNL1afJJDUrOA6C8?si=98147bf1a466440c" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">TE RECOMIENDO UNA CANCIÓN &lt;3</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                ...
                                <em>I'm always sayin' I won't change but<br aria-hidden="true">
    I ain't the same<br aria-hidden="true">
    Everything is different, I can't complain<br aria-hidden="true">
    Don't know what you missing<br aria-hidden="true">
    Shame on you<br aria-hidden="true">
    Yeah, yeah, yeah<br aria-hidden="true">
    Shame on you<br>
    Everything is strange, that's just a game<br aria-hidden="true">
    Everybody tripping, throwing it away<br aria-hidden="true">
    We was getting lifted, now we getting paid<br aria-hidden="true">
    Shame on you</em>
                            </td>
                        </tr>
                    </tbody></table>
