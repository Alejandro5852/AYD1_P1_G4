...
controller.getEmailHTML = (nombre, telefono) => {
    let date = new Date();
    /*
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                ...
                                El motivo del presente correo es para notificarte que tu información de contacto ha sido modificada en la lista del grupo 4 de AyD1 
                            </td>
                        </tr>
                    </tbody></table>
                    <!--[if mso]>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 10px;">
                                    <a class="mcnButton " title="TE RECOMIENDO UNA CANCIÓN &lt;3" href="https://open.spotify.com/track/5EBjirsg69LLpHqvkwm8nO?si=8bc443d4a0d94ef5" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">TE RECOMIENDO UNA CANCIÓN &lt;3</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">                        
                                <em>
                                    El periódico, el café<br aria-hidden="true">
                                    La merienda en la lonchera<br aria-hidden="true">
                                    La bendición con fe, el beso pa' la abuela<br aria-hidden="true">
                                    La camioneta full, los chamos pa' la escuela<br aria-hidden="true">
                                    Porque no sirven para comer los<br aria-hidden="true">
                                    Pollos en mi cazuela<br aria-hidden="true"><br aria-hidden="true">
                                    Los "¿cómo está, compadre?"<br aria-hidden="true">
                                    Los "vamos que ya es tarde"<br aria-hidden="true">
                                    Los "viste que ya mataron aquel<br aria-hidden="true">
                                    Coño 'e su madre"<br aria-hidden="true">
                                    Pan con el portu, el refresco con los chinos<br aria-hidden="true">
                                    El programa mañanero que<br aria-hidden="true">
                                    Conducen los sifrinos<br aria-hidden="true">
                                </em>
                            </td>
                        </tr>
                    </tbody></table>
